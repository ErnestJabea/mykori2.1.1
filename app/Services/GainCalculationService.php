...
class GainCalculationService
{
    ...
    public function getProductsWithGains()
    {
        ...
        $result = $ProductController->getProductsWithGainsUser($user->id);
        ...
        $user->gain_pmg = $totalPortefeuillePmg;
        $user->gain = $totalPortefeuilleFcp;
        ...
        foreach ($products as $product) {
            ...
            foreach ($allTransactions as $transaction) {
                if ($product->products_category_id == 1) {
                    ...
                    // Pour les produits PMG, vérifier si la date d'échéance est supérieure à la date actuelle
