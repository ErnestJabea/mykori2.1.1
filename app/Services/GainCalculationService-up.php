...
class GainCalculationService
{
    ...
    public function getProductsWithGains()
    {
        ...
        foreach ($products as $product) {
            ...
            $user->gain_pmg = $gainsParType[2] + $transaction -> montant_initiale;
            $user->gain = $valorisationPortefeuille;
            $user-> save();
        }

        // Ajouter les gains agrégés au résultat
        // $result['gains_par_type'] = $gainsParType;
