    ...
    <div class="flex flex-wrap gap-4 xxl:gap-4 mb-8 w-full">
        ...
        <div class="flex-1 min-w-[200px] box bg-white dark:bg-bg3 border border-n30 p-4 rounded-2xl flex items-center gap-3 hover:border-primary/50 duration-300 transition-all shadow-sm">
            ...
            <div>
                ...
                <h4 class="text-base font-bold mb-0 text-n700 leading-none whitespace-nowrap">{{ number_format($globalTotalInvesti, 0, ' ', ' ') }}</h4>
            </div>
        </div>
        ...
        <div class="flex-1 min-w-[200px] box bg-white dark:bg-bg3 border border-n30 p-4 rounded-2xl flex items-center gap-3 hover:border-success/50 duration-300 transition-all shadow-sm">
            ...
            <div>
                ...
                <h4 class="text-base font-bold mb-0 text-success leading-none whitespace-nowrap">+{{ number_format($globalTotalInterets, 0, ' ', ' ') }}</h4>
            </div>
        </div>
        ...
        <div class="flex-1 min-w-[200px] box bg-white dark:bg-bg3 border border-n30 p-4 rounded-2xl flex items-center gap-3 hover:border-secondary1/50 duration-300 transition-all shadow-sm">
            ...
            <div>
                ...
                <h4 class="text-base font-bold mb-0 text-secondary1 leading-none whitespace-nowrap">{{ $activeClientsCount }}</h4>
            </div>
        </div>
        ...
        <div class="flex-1 min-w-[200px] box bg-white dark:bg-bg3 border border-n30 p-4 rounded-2xl flex items-center gap-3 hover:border-red-500/50 duration-300 transition-all shadow-sm">
            ...
            <div>
                ...
                <h4 class="text-base font-bold mb-0 text-red-500 leading-none whitespace-nowrap">{{ $inactiveClientsCount }}</h4>
            </div>
        </div>
    </div>
    ...
    <div class="box col-span-12 shadow-sm border border-n30">
        <div class="bb-dashed mb-4 flex flex-wrap items-center justify-between gap-4 pb-4 lg:mb-6 lg:pb-6">
            ...
            <div class="flex items-center gap-4">
                <form action="{{ route('customer') }}" method="GET" class="relative">
                    ...
                    <button type="submit" class="absolute right-1 top-1/2 -translate-y-1/2 bg-primary text-white p-1 rounded-full w-8 h-8 flex items-center justify-center hover:bg-primary/90 transition-all">
        ...
        <div class="overflow-x-auto pb-4">
            <table class="w-full min-w-[1000px]">
                ...
                <div class="px-6 py-2">
                    <small class="text-xs text-muted">Affichage de {{ $customers->firstItem() }} à {{ $customers->lastItem() }} sur {{ $customers->total() }} clients</small>
                </div>
                <tbody>
