            ...
            <div class="content-left">
                <div class="title-wrapper">
                    <div class="bb-dashed mb-4 flex flex-wrap items-center justify-between gap-3 pb-4 lg:mb-6 lg:pb-6">
                        <h4 class="h4">XAF {{ number_format( $user_->solde + $user_->gain + $user_->gain_pmg, 0, ' ', ' ') }}</h4>
                ...
                <div class="content-card-elt">
                    <div class="card-portofolio">
                        ...
                        <h4 class="h4">XAF {{ number_format( $user_ -> gain_pmg, 0, ' ', ' ') }}</h4>
                    ...
                    <div class="card-portofolio">
                        ...
                        <h4 class="h4">XAF {{ number_format($user_->solde + $user_ -> gain, 0, ' ', ' ') }}</h4>
                        {{-- <span class="flex items-center gap-1 text-sm text-primary">
                                    <i class="las la-arrow-up text-base"></i> {{ $user_->percent }}%
                                </span> --}}
                    </div>
                    <div class="card-portofolio">
                        ...
                        <h4 class="h4">XAF {{ number_format($user_->gain + ($user_->gain_pmg-$user_->solde_pmg), 0, ' ', ' ') }}
                        </h4>
                        {{-- <span class="flex items-center gap-1 text-sm text-primary">
