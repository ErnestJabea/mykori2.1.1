...
<main class="main-content has-sidebar">
    <div class="grid grid-cols-12 gap-4 xxl:gap-6">
        <div class="col-span-12 flex flex-col gap-4 md:col-span-7 lg:col-span-8 xxl:gap-6">
            <p><a href="{{ route('customer-detail', ['customer' => $customer->id]) }}" style="font-size:15px; color: #ebb009">
                    < Retour</a>
            </p>
...
<div class="panel panel-bordered">
    ...
    <div class="panel-body  "><div class="flex flex-wrap">
        ...
        <div class="form-group mb-3">
            ...
            <select name="transaction_id" class="form-control" required>
                @foreach($transactionsUsers as $trans)
                        @php
                            $product= App\Product::where('id', $trans->product_id)->first();
                        @endphp
...
<div id="popup-rachat-partiel" class="mfp-hide white-popup-block">
    ...
    <form action="{{ route('transactions.rachat-partiel') }}" method="POST">
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" name="amount_brut" class="form-control" placeholder="Ex: Montant du rachat" required>
        </div>
        <div class="form-group mb-3">
            <label>Frais de gestion (XAF)</label>
            <input type="number" name="amount_frais" class="form-control" placeholder="Frais de gestion " required>
        </div>
        <div class="text-right mt-4">
