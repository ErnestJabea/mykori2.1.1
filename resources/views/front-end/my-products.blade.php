                    ...
                    <div class="item-product">
                        ...
                        <div class="inner-header">
                            ...
                            <div class="content-label-info">
                                ...
                                <div class="response-">
                                    {{ $my_product['days_months']['months'] }} mois @if ($my_product['days_months']['days']>0) {{ $my_product['days_months']['days'] }} jour(s) @endif</div>
                            </div>
                            <div class="content-label-info">
                    ...
                    <div class="item-product">
                        ...
                        <div class="inner-header">
                            ...
                            <div class="content-label-info">
                                ...
                                <div class="response-">
                                    XAF {{ number_format(floor((float)$my_product['vl_actuel']), 0, ' ', ' ') }}
                                </div>
                            </div>
                            <div class="content-label-info">
